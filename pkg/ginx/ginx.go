...
func WrapReq[Req any](fn func(*gin.Context, Req) (api.Response, error)) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		if err != nil {
			...
			ctx.JSON(customErr.HttpCode, api.Response{
				Code:    customErr.Code,
...
func WrapUri[Req any](fn func(*gin.Context, Req) (api.Response, error)) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		var req Req
		err := ctx.BindUri(&req)
		...
		if err != nil {
			...
			ctx.JSON(e.HttpCode, api.Response{
				Code:    e.Code,
				Message: e.Msg,
				Data:    nil,
			})
