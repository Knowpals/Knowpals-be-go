...
type StudentReport struct {
	gorm.Model
	StudentID uint   `gorm:"column:student_id;type:bigint;not null;index:idx_student_video,unique"`
	VideoID   uint   `gorm:"column:video_id;type:bigint;not null;index:idx_student_video,unique"`
